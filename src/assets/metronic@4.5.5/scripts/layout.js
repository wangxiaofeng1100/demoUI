...
var Layout = function () {
    ...
    var handleFixedSidebar = function () {
        ...
        if (App.getViewPort().width >= resBreakpointMd) {
            menu.attr("data-height", _calculateFixedSidebarViewportHeight() - 42);
    ...
    var handleSidebarToggler = function () {
        ...
        // handle the search bar toogle
        $('.page-sidebar .nav-item  a').on('click', function (event) {
            if ($(event.target).parents(".nav-item").hasClass("open")) {
                return;
            }
            else {
                var menu = $('.page-sidebar-menu');
                menu.find('li.nav-item.open').each(function(index ,a) {
                    $(a).removeClass('open');
                    $(a).find('> a > .arrow.open').removeClass('open');
                    $(a).find('> .sub-menu').slideUp();
                });
            }
        });
    };
    ...
    return {
        ...
        // handles recalculate height when window resize.
